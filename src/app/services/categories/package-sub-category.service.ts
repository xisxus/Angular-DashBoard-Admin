...
export class PackageSubCategoryService {
  private apiUrl = 'http://localhost:5270/api/PackageSubCategory';
  ...
  updateSubCategory(subCategory: PackageSubCategoryListDTO): Observable<PackageSubCategoryListDTO> {
    return this.http.put<PackageSubCategoryListDTO>(`${this.apiUrl}/${subCategory.packageSubCategoryID}`, subCategory);
  }
